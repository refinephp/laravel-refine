...
namespace Refinephp\LaravelRefine\Tests\Feature;

use Refinephp\LaravelRefine\Tests\App\Models\Author;
...
class FilterableByMultipleFieldInRelationTest extends TestCase
{
    ...
    {
        $originalSilentMode = $this->app['config']->get('laravel-refine.silent');
        $this->app['config']->set('laravel-refine.silent', false);
        ...
        $this->app['config']->set('laravel-refine.silent', $originalSilentMode);
    }
}
